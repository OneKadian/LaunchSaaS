...
const GatedContent = () => {
  ...
  return (
    <>
      <div class=" bg-gray-900 h-screen w-full mt-8 flex">
        <aside
          ...
          class="fixed top-0 left-0 mt-2 w-64 h-full pt-14 transition-transform -translate-x-full hidden lg:block bg-gray-900 md:translate-x-0"
          aria-label="Sidenav"
          id="drawer-navigation"
        >
          <div class="overflow-y-auto py-5 px-3 h-full mt-8 bg-gray-900 text-gray-300">
            <ul class="space-y-2">
              <li>
                <a
                  href="#"
              ...
              <li>
                ...
                >
                  <svg
                    aria-hidden="true"
                    class="flex-shrink-0 w-6 h-6 transition duration-75 text-gray-500 hover:text-gray-900"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                    xmlns="http://www.w3.org/2000/svg"
                  >
          ...
          <div class="hidden absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex bg-gray-900 z-20">
            <a
              href="#"
            ...
            <div
              class="hidden z-50 my-4 text-base list-none bg-gray-900 rounded divide-y divide-gray-100 shadow"
