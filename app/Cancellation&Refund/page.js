...
const CancellationRefundContent = [
  {
    ...
    description:
      "If you are not satisfied with your OneKadian subscription, you may request a refund within 2 hours of your purchase. To request a refund, please send an email to manageanirudh@gmail.com with your refund request, including the reason for your request.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Upon cancellation and refund approval, you will not be obligated to make any future subscription payments. Your access to OneKadian and its associated resources will be terminated.",
  },
  {
