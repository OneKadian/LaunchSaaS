  ...
  return (
    <header className="">
      ...
      >
        ...
        <Dialog.Panel className="fixed inset-y-0 border-l border-gray-800 right-0 z-50 w-3/5 overflow-y-auto bg-gray-800 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
